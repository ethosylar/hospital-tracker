	...
	class PermissionSeeder extends Seeder
	{
		public function run(): void
		{
			...
			*/
			...
			['code' => 'agreements.document-types.manage','name' => 'Manage Agreement Document Types','module' => 'Agreements',],
			['code' => 'agreements.documents.ocr','name' => 'Request OCR for Agreement Documents','module' => 'Agreements',],
			];
