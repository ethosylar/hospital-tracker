<?php
	...
	class FileController extends Controller
	{
		...
		*/
		...
		public function projectDownload(Request $request, Project $project, StoredFile $file)
		{
			$isLinked = $project->files()
			->where('dt_files.id', $file->id)
			->exists();
		...
		*/
		...
		public function taskDownload(Request $request, ProjectTask $task, StoredFile $file)
		{
			$isLinked = $task->files()
			->where('dt_files.id', $file->id)
			->exists();
